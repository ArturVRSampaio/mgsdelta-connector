...
namespace ANTIBigBoss_s_MGS_Delta_Trainer
{
    public class MemoryManager
    {
        ...
        /// <summary>
        /// Opens a handle to the specified process with full access rights. <br></br>
        /// We use this for reading/writing to the game's memory
        /// </summary>
        /// <param name="process">The target process to open.</param>
        /// <returns>A handle to the process, or IntPtr.Zero on failure.</returns>
        ...
        public IntPtr FindDynamicAob(string key)
        {
            ...
            // If start and end addresses are defined, use them to calculate size. Otherwise do a full range scan.
